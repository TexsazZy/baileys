...
![WhatsApp API](https://img1.pixhost.to/images/6059/604650462_pinongacengkontolnyagedepanjangsekaranglagisange.jpg)
...
<p align="center">
  ...
  <!-- NPM version -->
  <a href="https://www.npmjs.com/package/TexsazZy">
    <img src="https://img.shields.io/npm/v/TexsazZy?color=blue&label=TexsazZy&logo=npm" alt="npm version">
  </a>

  <!-- NPM total downloads -->
  <a href="https://www.npmjs.com/package/TexsazZy">
    <img src="https://img.shields.io/npm/dt/TexsazZy?label=downloads&logo=npm" alt="npm downloads">
  </a>

  <!-- GitHub Stars -->
  <a href="https://github.com/TexsazZy/baileys">
    <img src="https://img.shields.io/github/stars/TexsazZy/baileys?style=social" alt="GitHub stars">
  </a>
  ...
  <!-- GitHub Repo -->
  <a href="https://github.com/TexsazZy">
    <img src="https://img.shields.io/badge/GitHub-TexsazZy-181717?logo=github" alt="GitHub Profile">
  </a>

  <!-- Instagram -->
  <a href="https://instagram.com/TexsazZy_">
    <img src="https://img.shields.io/badge/Instagram-@TexsazZy-E4405F?logo=instagram&logoColor=white" alt="Instagram">
  </a>
</p>
...
[꒰⚘꒱ Admin Contact ꒱⟡](https://linkbio.co/TexsazZy)
...
```javascript
import makeWASocket, { Browsers } from 'TexsazZy'
...
```javascript
const { default: makeWASocket, Browsers } = require('TexsazZy')
...
```javascript
import makeWASocket from 'TexsazZy'
...
```javascript
import makeWASocket, { useMultiFileAuthState } from 'TexsazZy'
...
```javascript
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from 'TexsazZy'
...
const connectAuth = async () => {
  ...
  const collection = client.db('TexsazZy').collection('sessions')
...
const logger = pino({ timestamp: () => `,"time":"${new Date().toJSON()}"` }).child({ class: 'TexsazZy' })
logger.level = 'fatal'
...
```javascript
import makeWASocket, { makeInMemoryStore } from 'TexsazZy'
    ...
    templateButtons: [
      {
        ...
        urlButton: {
          ...
          url: 'https://whatsapp.com/channel/0029Vb6UqCcAjPXEpY3mC10V'
        }
      },
      {
        index: 2,
    ...
    interactiveButtons: [
      ...
      },
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: 'https://whatsapp.com/channel/0029Vb6UqCcAjPXEpY3mC10V',
          merchant_url: 'https://whatsapp.com/channel/0029Vb6UqCcAjPXEpY3mC10V'
        })
      },
      {
        name: 'cta_copy',
        buttonParamsJson: JSON.stringify({
          ...
          copy_code: 'https://whatsapp.com/channel/0029Vb6UqCcAjPXEpY3mC10V'
        })
      },
      {
        name: 'cta_call',
...
import { downloadMediaMessage, getContentType } from 'TexsazZy'
